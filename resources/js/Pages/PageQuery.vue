<template>
      ...
      <div class="border-b border-gray-200">
        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900" style="font-size: 30px;">Page Performance</h1>
          </div>
  ...
  { name: 'Page', href: 'pagequery', current: true, id: "PageQuery" },
...
const paginatedData = computed(() => {
  ...
  return pageAnalyticsData.value.slice(start, end);
});

const totalPages = computed(() => {
  return Math.ceil(pageAnalyticsData.value.length / itemsPerPage.value);
});
