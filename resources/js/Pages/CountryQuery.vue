<template>
  ...
  { name: 'Country', href: 'countryquery', current: true, id: "CountryQuery" },
...
const paginatedData = computed(() => {
  ...
  return countryAnalyticsData.value.slice(start, end);
});

const totalPages = computed(() => {
  return Math.ceil( countryAnalyticsData.value.length / itemsPerPage.value);
});
