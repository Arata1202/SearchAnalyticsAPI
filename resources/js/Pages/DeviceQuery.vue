<template>
      ...
      <div class="border-b border-gray-200">
        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900" style="font-size: 30px;">Device Performance</h1>
          </div>
          ...
          <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <table class="min-w-full divide-y divide-gray-300">
                <thead>
                  <tr>
                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0" style="width: 52%;">Device</th>
                ...
                <tbody class="divide-y divide-gray-200">
                  <tr v-for="item in paginatedData" :key="item.page">
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{{ deviceTranslations[item.keys[0]] }}</td>
  ...
  { name: 'Device', href: 'devicequery', current: true, id: "DeviceQuery" },
...
const paginatedData = computed(() => {
  ...
  return deviceAnalyticsData.value.slice(start, end);
});

const totalPages = computed(() => {
  return Math.ceil(deviceAnalyticsData.value.length / itemsPerPage.value);
});
